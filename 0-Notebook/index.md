...
You can check the rest of work and problems archive on my  [GitHub](https://github.com/mstfelq/IOI-Training). This notebook is designated for collecting problems with similar Ideas and reflecting upon solutions with some notes on algorithms and other programming topics. You can also check my website: [MustafaElq.sa](https://MustafaElq.sa).
