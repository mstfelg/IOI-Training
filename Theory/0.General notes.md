...
# Debugging 
  * List your common mistakes while coding.
...
# General tips
  * Plan your code, jot down your main structure & ideas, think whether there's a better way. (See also: [Pseudocode](https://en.wikipedia.org/wiki/Pseudocode))
